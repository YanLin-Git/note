...
2. 启动训练
    - 单机单卡: `python train.py`
    - 单机多卡: `torchrun --nproc_per_node 2 --use_env train.py`
    - 多机多卡
        1. `torchrun --node_rank 0 --nproc_per_node 2 --use_env --master_addr "192.168.0.1" train.py`
        2. `torchrun --node_rank 1 --nproc_per_node 2 --use_env --master_addr "192.168.0.1" train.py`
